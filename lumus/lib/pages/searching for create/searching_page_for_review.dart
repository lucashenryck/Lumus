...
import 'package:lumus/pages/create/create_review_about_movie.dart';
import 'package:lumus/pages/create/create_review_about_series.dart';

class SearchingForReviewPage extends StatefulWidget {
  const SearchingForReviewPage({super.key});

  @override
  State<SearchingForReviewPage> createState() => _SearchingForReviewPageState();
}

class _SearchingForReviewPageState extends State<SearchingForReviewPage> 
    ...
    return GestureDetector(
      ...
      try{
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => CreateReviewAboutMovie(
              movie: movieDetails,
            ),
          ),
        );
      ...
      onTap: () async {
        try{
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CreateReviewAboutSeries(
