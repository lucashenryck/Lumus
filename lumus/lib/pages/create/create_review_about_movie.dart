...
class CreateReviewAboutMovie extends StatefulWidget {
  const CreateReviewAboutMovie({super.key, this.movie});
  final Movie? movie;

  @override
  State<CreateReviewAboutMovie> createState() => _CreateReviewAboutMovieState();
}

class _CreateReviewAboutMovieState extends State<CreateReviewAboutMovie> {
  ...
  void sendReviewAboutMovie(
    String userId,
    String username,
    String? profilePhoto,
  ) async {
    try{
      String response = await FirestoreMethods().sendReviewAboutMovie(
        ...
        actions: [
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () => sendReviewAboutMovie(
                user.id, 
                user.username, 
                user.profilePhoto
              ),
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: 'O que você achou desse filme?',
